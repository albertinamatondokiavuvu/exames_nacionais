 ...
 *   https://datatables.net/download/#bs5/dt-1.13.4/b-2.3.6/date-1.4.1/r-2.4.1
 *
 * Included libraries:
 *   DataTables 1.13.4, Buttons 2.3.6, DateTime 1.4.1, Responsive 2.4.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.4/b-2.3.6/date-1.4.1/r-2.4.1",
