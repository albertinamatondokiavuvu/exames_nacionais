    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            @if (Auth::user()->tipo_user == 'admin')
                <li class="nav-item">
                    ...
                    <div class="collapse" id="utilizador">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('user_add_dp') }}">Cadastrar</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#relat" aria-expanded="false"
                        aria-controls="relat">
                        <i class="typcn typcn-document-text menu-icon"></i>
            ...
            @elseif(Auth::user()->tipo_user == 'DP')
                <li class="nav-item">
                    ...
                    <div class="collapse" id="utilizador">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('user_add_dm') }}">Cadastrar</a>
                            </li>
            ...
            @elseif(Auth::user()->tipo_user == 'DM')
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#centroExame_exame" aria-expanded="false"
                        aria-controls="centroExame_exame">
                        <i class="typcn typcn-document-text menu-icon"></i>
                    ...
                    <div class="collapse" id="centroExame_exame">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('centro_add') }}">Cadastrar</a>
                            </li>
            ...
            @elseif(Auth::user()->tipo_user == 'DC')
                <li class="nav-item">
                    ...
                    <div class="collapse" id="utilizador">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('user_add') }}">Cadastrar</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#turma" aria-expanded="false"
                        aria-controls="turma">
                        <i class="typcn typcn-document-text menu-icon"></i>
                    ...
                    <div class="collapse" id="turma">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('turma_add') }}">Cadastrar</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('turma_index') }}">Listar</a>
                            </li>
                        </ul>
                    </div>
                </li>
