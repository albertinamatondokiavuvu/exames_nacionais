...
<head>
    ...
    <title>Relatório de processos dados entrada</title>
    <style>
        <?php echo $bootstrap;
        echo $css;
        ?>
...
<body>
    ...
    <div class="text-center">
        <h1 class="text-primary" style="margin-top: 100px; margin-bottom: 50px;" > LISTA DE TOTAL DE ENTRADA DE PROCESSOS</h1>
    </div>
    <table  class=" table">
        <thead >
            <tr >
